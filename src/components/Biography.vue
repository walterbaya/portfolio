  ...
  >
    ...
    <div class="row px-md-5">
      ...
      <div class="col-12 px-3">
        <h1 class=" p-md-2 p-0 py-md-1 color-greyblue py-2">Estudios Universitarios</h1>
        <ul class="list-unstyled">
          <h2 class="px-md-1 p-0  py-1 mx-md-3  mx-1 py-md-1 text-dark" id="university">Universidad de Buenos Aires</h2>
          <li>
            <p class="px-md-1 p-0  mx-md-3  mx-1 py-md-1 text-dark" id="degree">
